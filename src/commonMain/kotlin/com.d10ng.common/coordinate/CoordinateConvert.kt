 ...
 */
internal object CoordinateConvert {
    private const val XPI = PI * 3000 / 180
    ...
    fun transformBD09ToGCJ02(lng: Double, lat: Double): DoubleArray {
        ...
        val theta = atan2(y, x) - 0.000003 * cos(x * XPI)
    ...
    fun transformGCJ02ToBD09(lng: Double, lat: Double): DoubleArray {
        val z = sqrt(lng * lng + lat * lat) + 0.00002 * sin(lat * XPI)
        val theta = atan2(lat, lng) + 0.000003 * cos(lng * XPI)
