...
config.set({
  "singleRun": true,
  "autoWatch": false,
  "basePath": "/Users/d10ng/project/kotlin/DLCommonUtil/build/js/packages/dl-common-util-test/node_modules",
  "files": [
    "/Users/d10ng/project/kotlin/DLCommonUtil/build/js/packages/dl-common-util-test/adapter-browser.js"
  ],
  "frameworks": [
    "mocha"
  ],
...
;(function(config) {
    ...
    const handler = (percentage, message, ...args) => {
        ...
        msg = msg.replace("/Users/d10ng/project/kotlin/DLCommonUtil/build/js", '');;
        console.log(msg);
    };
